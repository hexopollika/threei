...
def create_qt_measurement_labels_section(
    *,
    visible_widget: Any,
    move_button: Any,
    anchor_widget: Any,
    ...
    section, form = create_qt_section("Measure Labels")
    add_form_row(
        form,
        "Visible",
...
def create_fallback_measurement_labels_rows(
    *,
    visible_widget: Any,
    move_button: Any,
    anchor_widget: Any,
    ...
    return [
        fallback_title_row("Measure Labels"),
