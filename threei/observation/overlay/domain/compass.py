...
class compass_overlay_component_t:
    ...
    def _resolve_direction_arrow_geometry (
        ...
        resolved_label_anchor_yx = self._direction_label_anchor_for_arrow_tip (
                tip_yx,
    ...
    def _direction_label_anchor_for_arrow_tip (
        self,
        tip_yx: tuple [float, float],
        arrow_unit_yx: tuple [float, float],
        gap_px: float,
        ...
        return self._boxed_label_anchor_for_arrow_tip (
            tip_yx,
            arrow_unit_yx,
            gap_px,
            label_metrics,
...
class compass_group_component_t:
    ...
    def build_with_fit (
        ...
        solution_request = compass_solver_request_t (
            ...
            build_request.sun_pa_deg,
            build_request.earth_pa_deg,
        )
    ...
    def _merge_group_scene (
        self,
        direction_scene: observation_overlay_scene_t,
        compass_scene: observation_overlay_scene_t,
    ) -> observation_overlay_scene_t:
...
class compass_solver_t:
    ...
    def solve_from_request (
        ...
        parsed_sun_pa_deg = self._normalize_optional_angle_deg (solve_request.sun_pa_deg)
